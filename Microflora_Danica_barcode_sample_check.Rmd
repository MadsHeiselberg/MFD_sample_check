...
# Data load
```{r}
ID_folder_path <- "C:/Users/CN61GS/OneDrive - Aalborg Universitet/Masseeksperimentet - Lab_data/ID_codes/" # Folder with all Microflora Danica scanned ID barcode + tube barcode files
ID_plate_path <- "C:/Users/CN61GS/OneDrive - Aalborg Universitet/Masseeksperimentet - Lab_data/plates/" # Folder with all plate scanned files (EXT and STO in the same folder) 
ID_files <- list.files(ID_folder_path, recursive = T, full.names = T)
plate_all <- list.files(ID_plate_path, recursive = T, full.names = T)
